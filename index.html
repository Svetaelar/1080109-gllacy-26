      ...
      <main>
        ...
        <section class="slider container">
          <div class="slider-controls">
            <button type="button" class="controls controls-active">Первый</button>
            <button type="button" class="controls">Второй</button>
            <button type="button" class="controls">Третий</button>
          </div>
